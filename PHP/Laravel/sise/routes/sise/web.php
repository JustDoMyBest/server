...
Route::get('frontend/courses/{coursetype}', 'FrontendController@courses');
// Route::get('frontend/courses/{coursetype}', 'FrontendController@courses');
// Route::get('frontend/courses/{coursetype}/{course}', 'FrontendController@courses');
Route::get('frontend/courses/{coursetype}/{course}', 'FrontendController@course_single');
// Route::get('frontend/files', 'FrontendController@files');
Route::get('frontend/files/{filetype}', 'FrontendController@files');
// Route::get('frontend/files/{filetype}/{file}', 'FrontendController@file_single');
Route::get('frontend/contact_uses', 'FrontendController@contact_uses');
Route::get('frontend/search', 'FrontendController@search');
